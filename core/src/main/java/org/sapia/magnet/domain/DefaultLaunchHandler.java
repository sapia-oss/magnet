...
public class DefaultLaunchHandler extends AbstractObjectHandler implements LaunchHandlerIF {
  ...
  private String _theWaitTime = "" + DEFAULT_WAIT_TIME;
  ...
  /** Indicates if the launcher should abort on error (true by default) */
  private String _abortOnError = "true";
  ...
  public int geWaitTime() {
    try {
      return _theWaitTime == null ? DEFAULT_WAIT_TIME : Integer.parseInt(_theWaitTime);
    } catch (NumberFormatException e) {
      throw new IllegalArgumentException("Invalid wait time for " + _theType + " (" + _theName + ")");
    }
  }

  /**
   * Returns the parent magnet of this default launch handler.
   *
   * @return The parent magnet of this default launch handler.
   */
  ...
  /**
   * Sets the <code>abortOnError</code> flag.
   * 
   * @param abortOnError if <code>true</code>, indicates that this instance's {@link #execute(String)} will throw a
   * {@link IllegalStateException} if an error occurs trying to launch the external process.
   */
  public void setAbortOnArror(String abortOnError) {
    _abortOnError = abortOnError;
  }
  
  /**
   * @return <code>true</code> if the launcher should throw an {@link IllegalStateException} if an error occurs internally
   * within its {@link #execute(String)} method.
   */
  public boolean isAbortOnError() {
    return _abortOnError == null ? true : _abortOnError.equalsIgnoreCase("true");
  }
   ...
   */
  public void setWaitTime(String aWaitTime) {
  ...
  public void render(MagnetContext aContext) throws RenderingException {
    _abortOnError = super.resolveValue(aContext, _abortOnError);
    _theWaitTime  = super.resolveValue(aContext, _theWaitTime);
